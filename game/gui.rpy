...
## 游戏内文本使用的字体。
define gui.text_font = "LXGWNeoXiHeiPlus.ttf"

## 角色名称使用的字体。
define gui.name_text_font = "LXGWNeoXiHeiPlus.ttf"

## 游戏外文本使用的字体。
define gui.interface_text_font = "LXGWNeoXiHeiPlus.ttf"
...
## 标题菜单和游戏菜单使用的图像。
define gui.main_menu_background = "images/bg_street_xmas.jpg"
